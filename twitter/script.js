...
if(list===null||list==''){
   for(i=0; i<1; i++){
   var youtubes = youtube[i];
   youtubes.setAttribute('src','https://www.youtube-nocookie.com/embed?playsinline=1&playlist=' + playlist + '&loop=1');
   }
}
...
document.getElementById('homeg').setAttribute("style", after);
...
document.getElementById('exploreg').setAttribute("style", before);
document.getElementById('explores').setAttribute("d", explores);
document.getElementById('notificationg').setAttribute("style", before);
document.getElementById('notifications').setAttribute("d", notifications);
document.getElementById('messageg').setAttribute("style", before);
...
document.getElementById('homeg').setAttribute("style", before);
document.getElementById('homes').setAttribute("d", homes);
document.getElementById('homesd').setAttribute("d", homesd);
document.getElementById('exploreg').setAttribute("style", after);
...
document.getElementById('exploreg').setAttribute("style", before);
document.getElementById('explores').setAttribute("d", explores);
document.getElementById('notificationg').setAttribute("style", after);
...
document.getElementById('notificationg').setAttribute("style", before);
document.getElementById('notifications').setAttribute("d", notifications);
document.getElementById('messageg').setAttribute("style", after);
